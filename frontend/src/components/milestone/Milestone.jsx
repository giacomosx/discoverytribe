...
const Milestone = ({milestone}) => {
    ...
    return (
        <li className="mb-10 ms-6">
            ...
            <span className={'text-sm text-gray-700 dark:text-gray-300 items-center flex'}>
                ...
                {milestone.destination?.destination_city}, {milestone.destination?.destination_state}, {milestone.destination?.destination_country}
            </span>
